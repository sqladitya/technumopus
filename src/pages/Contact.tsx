        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12">
            ...
            <div className="bg-white rounded-2xl shadow-xl p-6 sm:p-8">
              <h2 className="text-xl sm:text-2xl font-bold text-tech-text-dark mb-6">
                Leave Us A Message
              </h2>
            ...
            <div className="space-y-4 sm:space-y-6">
              <div className="mb-6 sm:mb-8">
                <h2 className="text-xl sm:text-2xl font-bold text-tech-text-dark mb-4">
                  Contact Information
                </h2>
                ...
                <div className="flex items-start gap-3 sm:gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm sm:text-base text-tech-text-medium">
                      ...
                      <br />
                      <a
                        href="mailto:support@technumopus.com"
                        className="hover:text-tech-primary transition-colors duration-300"
                      >
